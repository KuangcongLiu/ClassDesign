...
http://localhost:9393/Properties/
                    ...
                    {
                        case "admin":
                            this.Response.Redirect("/Admin?admin_id=" + logon.Id);
                            break;
                        case "staff":
                            this.Response.Redirect("/Staff?staff_id=" + logon.Id);
                            break;
                        case "student":
                            this.Response.Redirect("/Student?student_id=" + logon.Id);
                            break;
                    }
                }
            }
